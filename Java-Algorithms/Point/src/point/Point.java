...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        double vertDifference = this.y - that.y;
        double horDifference = this.x - that.x;
        if (horDifference == 0) {
            if (vertDifference == 0) {
                return (inf * -1);
            }
        ...
        return vertDifference / horDifference;
        /* YOUR CODE HERE */
    }
    ...
    public int compareTo(Point that) {
        int horDiff = this.x - that.x;
        int verDiff = this.y - that.y;
        if (verDiff == 0) {
            if (horDiff == 0) {
                return 0;
            }
